  ...
  return (
    <div className="space-y-1.5 sm:space-y-3">
      <button
        ...
        className="relative aspect-[3/2] w-full overflow-hidden rounded-[var(--radius)] border border-[var(--border)] bg-surface text-left sm:aspect-[4/5]"
      >
        <Image
        ...
        <div className="flex gap-1 overflow-x-auto pb-1 sm:gap-2">
          {product.images.map((src, i) => (
            <button
              ...
              type="button"
              onClick={() => setActive(i)}
              className={`relative h-10 w-10 shrink-0 overflow-hidden rounded-[var(--radius)] border bg-surface transition-colors sm:h-20 sm:w-16 ${
